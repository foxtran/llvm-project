...
bool CompilerInvocation::createFromArgs(
  ...
  // -f[no-]check-unreachable
  if (args.hasFlag(clang::options::OPT_fcheck_unreachable,
                   clang::options::OPT_fno_check_unreachable, false)) {
    invoc.loweringOpts.setCheckUnreachable(true);
  }
