...
subroutine stop_test()
 ...
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c0]], %[[c0]], %[[false]])
...
subroutine stop_code()
 ...
 ! CHECK-DAG: %[[false:.*]] = arith.constant false
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c42]], %[[c0]], %[[false]])
 ! CHECK-NEXT: fir.unreachable
end subroutine
...
subroutine stop_error()
 ...
 ! CHECK-DAG: %[[false:.*]] = arith.constant false
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c_1]], %[[c_1]], %[[false]])
 ! CHECK-NEXT: fir.unreachable
end subroutine
...
subroutine stop_quiet()
 ...
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c0]], %[[c0]], %[[bi1]])
 ! CHECK-NEXT: fir.unreachable
end subroutine
...
subroutine stop_quiet_constant()
 ...
 ! CHECK-DAG: %[[c0:.*]] = arith.constant 0 : i32
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c0]], %[[c0]], %[[true]])
 ! CHECK-NEXT: fir.unreachable
end subroutine
...
subroutine stop_error_code_quiet(b)
 ...
 ! CHECK: fir.call @_Fortran{{.*}}StopStatement(%[[c66]], %[[c1]], %[[bi1]])
 ! CHECK-NEXT: fir.unreachable
end subroutine
...
subroutine stop_char_lit
  ...
  ! CHECK: fir.call @{{.*}}StopStatementText(%[[buff]], %[[len]], %[[c0]], %[[false]]) {{.*}}:
  ! CHECK-NEXT: fir.unreachable
  stop 'crash'
